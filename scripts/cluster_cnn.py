...
print("Clustering cnn embeddings")
clustering_cnn = KMeans(n_clusters=36, random_state=0).fit(cnn_data)
labs_cnn = clustering_cnn.labels_

clustering_cnn_vis = KMeans(n_clusters=36, random_state=0).fit(cnn_umap)
labs_cnn_vis = clustering_cnn_vis.labels_

pkl.dump([labs_cnn, labs_cnn_vis], open("data/cnn_part_kmeans_umap_clusters","wb"))
